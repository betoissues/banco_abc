            ...
            <div class="section no-pad-bot">
                <div class="container">
                    ...
                    <div class="row center valign-wrapper">
                        <h5 class="header col white-text s12 light">Bienvenido a E Bank</h5>
                    </div>
...
$(function(){
         Materialize.toast('Credenciales incorrectas. Si no tiene una cuenta, por favor cree una.', 4000, 'red darken-2 white-text')
});
</script>";
}
?>
